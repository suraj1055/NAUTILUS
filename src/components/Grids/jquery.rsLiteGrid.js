        ...
        var events,
            ...
            DOM = {
                ...
                init: function () {
                    ...
                    $elem.bind('addRow.rsLiteGrid', DOM.addLastRow).bind('delRow.rsLiteGrid', DOM.delRow).bind('getData.rsLiteGrid', json.getData).bind('setData.rsLiteGrid', json.setData).bind('create.rsLiteGrid', events.onCreate).bind('destroy.rsLiteGrid', events.onDestroy).bind('onAddingRow.rsLiteGrid', events.onAddingRow).bind('onAddRow.rsLiteGrid', events.onAddRow).bind('onRemovingRow.rsLiteGrid', events.onRemovingRow).bind('onRemoveRow.rsLiteGrid', events.onRemoveRow);
