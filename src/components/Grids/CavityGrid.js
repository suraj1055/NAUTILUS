                                                                                ...
                                                                                {isRowId === value.id ?
                                                                                    (
                                                                                        <td onMouseOut={handleEditFormSubmit}>
                                                                                            ...
                                                                                            <input type='text' className="form-control" style={{backgroundColor:'#fff'}} name={`value${key2}`} onChange={handleEditFormChange} defaultValue={NewRow2[key1][`value${key2}`] || ''} autoFocus />
                                                                                    ...
                                                                                    (
                                                                                        <td onClick={(event) => setId(event, value)}>
                                                                                            ...
                                                                                            <input type='text' name={`value${key2}`} style={{backgroundColor:'#fff'}} className="form-control" defaultValue={NewRow2[key1][`value${key2}`] || ''} readOnly />
